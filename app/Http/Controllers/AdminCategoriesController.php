<?php namespace App\Http\Controllers;
	...
	class AdminCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Categoría","name"=>"category_id","join"=>"categories,name"];
			...
			$this->form[] = ['label'=>'Categoría','name'=>'category_id','type'=>'select2','validation'=>'min:1|max:255','width'=>'col-sm-10','datatable'=>'categories,name'];
